...
<div class="container mh-400" style="margin-top:30px;">
    <div class="container lower-box box-primary" style="text-align: center;">
        <?php if($cliente!= null ) { ?>
            <h2 class="section-heading">A buscado al Cliente con el <?= $parametro ?> "<?= $palabra ?>" </h2>
            <h2 class="section-heading">Hay un total de: <?= $numero ?> Clientes registrados en el sitema con ese <?= $parametro ?></h2>
            <hr class="primary"> <?php }
            else{ ?>
                <h2 class="section-heading">No hay Clientes cargados Con ese <?= $parametro ?>: "<?= $palabra?>" en el Sistema</h2>
                <hr class="primary"> <?php } ?>
            </div>
            <div class="container">
                <div class="row">
        ...
        {
            {
                ...
                <div id="navegador">
                    <ul>
                        <li><a href="/vista/clientesparametrolimit/<?= $parametro; ?>/<?= $numero; ?>/<?= $palabra; ?>/<?= $parametro; ?>/<?= -1; ?>/<?= $longitud; ?>/<?= $entrada; ?>/<?= $entrada; ?>/">Siguiente</a></li>
                        <?php
                        for ($contador = 1; $contador < $longitud; $contador++){
                            ?>
                            <li><a href="/vista/clientesparametrolimit/<?= $parametro; ?>/<?= $numero; ?>/<?= $palabra; ?>/<?= $parametro; ?>/<?= $pantalla; ?>/<?= $longitud; ?>/<?= $pantalla; ?>/<?= $pantalla; ?>/"><?php print_r($pantalla); ?></a></li>
                            <?php
                            $entrada++;
                            $pantalla++;
                        }
                        ?>
                        <li><a href="/vista/clientesparametrolimit/<?= $parametro; ?>/<?= $numero; ?>/<?= $palabra; ?>/<?= $parametro; ?>/<?= -2; ?>/<?= $longitud; ?>/<?= $entrada; ?>/<?= $pantalla; ?>/">Anterior</a></li>
                    </ul>
                </div>
                <?php
            }
