...
function pdfsimple()
{
	...
	function pdfcargamanual($fecha, $entrega_c, $doctor, $observaciones, $a_cuenta, $saldo, $r_fecha, $proc, $armason_l, $lejos_pesos, $armason_c, $cerca_pesos, $lejos_od, $cilindri_l_od, $l_en_grados_od, $l_pesos_od, $lejos_oi, $cilindri_l_oi, $l_en_grados_oi, $l_color, $l_pesos_oi, $cerca_od, $c_cerca_od, $c_en_grados_od, $c_pesos_od, $cerca_oi, $cilindri_c_oi, $c_en_grados_oi, $c_color, $c_pesos_oi, $calibre, $puente, $subtotal, $senia, $saldo_total)
{
	if(!empty($_SESSION))
	{
		$email = $_SESSION["email"];
