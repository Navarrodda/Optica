	...
	if(!empty($_SESSION))
	{
		...
		if(!empty($cliente))
		{
			...
			//Nombre{
				$pdf->SetY(16);
				$pdf->SetX(124);
				$resultadousuario = $usuario->getNombre() .' '. $usuario->getApellido();
				$pdf->MultiCell(145,15,$resultadousuario);
			//Nombre}
			//Apellido{
			//Senior}
			//Observaciones{
			...
			*/
			...
			$pdf->SetY(25);
			$pdf->SetX(152.6);
			//$pdf->MultiCell(145,15,$senia[0]->getACuenta());
				//A cuenta}
				//Saldo{
			$pdf->SetY(30.3);
			$pdf->SetX(152.6);
			//$pdf->MultiCell(145,15,$senia[0]->getSaldo());
				//Saldo}
				//}
				//2 Parte{
				//Fecha{
			...
			$pdf->SetY(92.5);
			$pdf->SetX(29.5);
			$resultadocliente = $cliente->getNombre() .' '. $cliente->getApellido();
			$pdf->MultiCell(135,15,$resultadocliente);
				//Nombre}
				//Apellido}
				//Senior}
				//Calle{
			$pdf->SetY(92.5);
			$pdf->SetX(110.5);
			$pdf->MultiCell(135,15,$cliente->getCalle());
				//Calle}
				//Telefono{
			$pdf->SetY(92.5);
			$pdf->SetX(165.5);
			...
			$pdf->SetY(99.5);
			$pdf->SetX(89.5);
			$pdf->MultiCell(145,15,$lente->getMedico());
				//Dr}
				//Proc{
			$pdf->SetY(99.5);
			$pdf->SetX(158.5);
			...
			$pdf->SetY(108.6);
			$pdf->SetX(160);
			//$pdf->MultiCell(145,15,$factura->getSaldoArmazoL());
				//$ Armazon Lejos}
				//Armazon Cerca{
			$pdf->SetY(117.9);
			$pdf->SetX(40.5);
			...
			$pdf->SetY(117.9);
			$pdf->SetX(160);
			//$pdf->MultiCell(145,15,$factura[0]->getSaldoArmazonC());
				//$ Armazon Cerca}
				//Lejos OD ESF{
			$pdf->SetY(127.9);
			$pdf->SetX(40.5);
			$pdf->MultiCell(145,15,$lente->getLejosOd());
				//Lejos OD ESF}
				//Cilindrico OD{
			$pdf->SetY(127.9);
			$pdf->SetX(68.5);
			//$pdf->MultiCell(145,15,$cliente->$cilindri_l_od);
				//Cilindrico OD}
				//En GRA OD{
			$pdf->SetY(127.9);
			$pdf->SetX(91.7);
			//$pdf->MultiCell(145,15,$cliente->$l_en_grados_od);
				//En GRA OD}
				//$ L OD{
			$pdf->SetY(128.2);
			$pdf->SetX(160);
			//$pdf->MultiCell(145,15,$factura[0]->getSaldoArmazoL());
				//$ L OD}
				//Lejos OI ESF{
			$pdf->SetY(132.6);
			$pdf->SetX(40.5);
			$pdf->MultiCell(145,15,$lente->getLejosOi());
				//Lejos OI ESF}
				//Cilindrico OI{
			$pdf->SetY(132.6);
			$pdf->SetX(68.5);
			//$pdf->MultiCell(145,15,$cliente->$cilindri_l_oi);
				//Cilindrico OI}
				//EN GRA OI{
			$pdf->SetY(132.6);
			$pdf->SetX(91.7);
			//$pdf->MultiCell(145,15,$cliente->$l_en_grados_oi);
				//EN GRA OI}
				//Color 1{
			$pdf->SetY(132.6);
			$pdf->SetX(120.2);
			$pdf->MultiCell(145,15,$lente->getColor());
				//Color 1}
				//$ L OI{
			$pdf->SetY(132.8);
			$pdf->SetX(160);
			...
			$pdf->SetY(137.6);
			$pdf->SetX(40.5);
			$pdf->MultiCell(145,15,$lente->getCercaOd());
				//Cerca OD ESF} 
				//Cilindrico OD{
			$pdf->SetY(137.6);
			$pdf->SetX(68.5);
			//$pdf->MultiCell(145,15,$cliente->$c_cerca_od);
				//Cilindrico OD}
				//EN GRA OD{
			$pdf->SetY(137.6);
			$pdf->SetX(91.7);
			//$pdf->MultiCell(145,15,$cliente->$c_en_grados_od);
				//EN GRA OD}
				//$ C OD{
			$pdf->SetY(137.7);
			$pdf->SetX(160);
			...
			$pdf->SetY(142.6);
			$pdf->SetX(40.5);
			$pdf->MultiCell(145,15,$lente->getCercaOi());
				//Cerca OI ESF}
				//Cilindrico OI{
			$pdf->SetY(142.6);
			$pdf->SetX(68.5);
			//$pdf->MultiCell(145,15,$cliente->$cilindri_c_oi);
				//Cilindrico OI}
				//EN GRA OI{
			$pdf->SetY(142.6);
			$pdf->SetX(91.7);
			//$pdf->MultiCell(145,15,$cliente->$c_en_grados_oi);
				//EN GRA OI}
				//Color 2{
			$pdf->SetY(142.6);
			$pdf->SetX(120.2);
			...
			$pdf->SetY(147.7);
			$pdf->SetX(26);
			$pdf->MultiCell(145,15,$lente->getDistancia());
				//D.I.}
				//Calibre{
			$pdf->SetY(147.7);
			$pdf->SetX(57.2);
			$pdf->MultiCell(145,15,$lente->getCalibre());
				//Calibre}
				//Puente{
			$pdf->SetY(147.7);
			$pdf->SetX(94.7);
			$pdf->MultiCell(145,15,$lente->getPuente());
				//Puente}
				//Sub Total{
			$pdf->SetY(147.7);
			$pdf->SetX(160);
